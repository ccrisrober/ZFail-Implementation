...
GLuint SimpleGLShader::add_uniform(const std::string& uniform_name) {
	GLuint v = glGetUniformLocation(mProgram, uniform_name.c_str());
	mUniformList[uniform_name] = v;
	return v;
}
